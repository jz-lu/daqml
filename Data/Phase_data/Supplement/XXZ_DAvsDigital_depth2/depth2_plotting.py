...
ROOT = ".\" # location at which noisy, depth 2 loss arrays are stored (both digital and DA)
...
title = f"{phase}_{nq}_{circ}_{d}_noisyaveraged.npy"
...
zafm_avg_DA = np.load("zAFM_8_DA_noisyaveraged.npy")
zafm_avg_D = np.load("zAFM_8_D_noisyaveraged.npy")
