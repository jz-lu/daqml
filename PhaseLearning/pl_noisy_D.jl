...
function get_new_noise_circuit()
    function get_composite()
       return composite(nbit::Int64) = chain(params_layer(nbit), ent_cx_noisy(nbit))
    end
...
npzwrite(string("paramsD_d", depth, "_q", num_qubit, "_p", phase, "_its", niters,"_task", task, ".npy"), params)
npzwrite(string("trainlossD_d", depth, "_q", num_qubit, "_p", phase, "_its", niters, "_task", task, ".npy"), loss_train_history)
npzwrite(string("timingD_d", depth, "_q", num_qubit, "_p", phase, "_its", niters, "_task", task, ".npy"), time_array)
...
npzwrite(string("TestlossesD_d", depth, "_q", num_qubit, "_p", phase, "_its", niters,"_task", task, ".npy"), row)
